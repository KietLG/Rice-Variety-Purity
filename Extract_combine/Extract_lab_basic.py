...
def extract_lab_features(image):
    ...
    Trích xuất 21 đặc trưng từ không gian LAB:
      Với mỗi kênh (L, A, B) tính: mean, std, skewness, kurtosis, median, min, max.
    """
...
def extract_all_features(image):
    """Ghép nối đặc trưng basic và LAB thành một vector đặc trưng."""
    feat_basic = extract_basic_features(image)   
    feat_lab = extract_lab_features(image)       
    return feat_basic + feat_lab
