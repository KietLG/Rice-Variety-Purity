...
csv_files = [
    'BC15_basic_ycrcb.csv',
    'huongthom_basic_ycrcb.csv',
    'nep_basic_ycrcb.csv',
    'q5_basic_ycrcb.csv',
    'tbr36_basic_ycrcb.csv',
    'tbr45_basic_ycrcb.csv',
    'th35_basic_ycrcb.csv',
    'thienuu_basic_ycrcb.csv',
    'xi_basic_ycrcb.csv'
]

def train_and_evaluate_model(csv_file):
    print(f"\nEvaluating models for {csv_file}")
